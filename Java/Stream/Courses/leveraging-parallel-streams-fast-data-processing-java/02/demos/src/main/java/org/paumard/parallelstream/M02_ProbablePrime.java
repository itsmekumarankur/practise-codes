...
/*
* Running the benchmarks will take some time. JMH makes several warm ups, iterations etc.
* to make sure the results are not completely random.
* The more runs you have, the better average performance and high / low performance information you get.
* */
