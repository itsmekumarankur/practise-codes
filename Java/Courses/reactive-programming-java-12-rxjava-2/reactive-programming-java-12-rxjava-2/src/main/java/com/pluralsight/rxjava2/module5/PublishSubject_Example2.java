...
public class PublishSubject_Example2 {

    private final static Logger log = LoggerFactory.getLogger(PublishSubject_Example2.class);
    ...
    public static void main(String[] args) {
        ...
        subjectManager.addEventProducer(
                ...
                UserServiceEvent_Observable.userServiceEventGenerator()
